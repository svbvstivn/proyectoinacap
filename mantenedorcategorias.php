<?php
session_start();
include_once'funcmantenedorcategorias.php';
...
<body >
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Mantención de categorias</li>
  </ol>
</nav>
...
<div class="card" >
    ...
    <table class="table-sm table-bordered">
      ...
      <tr>
            ...
            <td><?php echo $r['desc_cate']?></td>
            <td>
                <a  class="btn btn-primary btn-sm" href="?edit=<?php echo $r['idCategoria']; ?>" onclick="return confirm('seguro que desea editar ?'); " >
                                            <i class="fa fa-dot-circle-o"></i> Editar
                                        </a>
                                        
                                        <a  class="btn btn-danger btn-sm" href="?del=<?php echo $r['idCategoria']; ?>" onclick="return confirm('seguro que desea eliminar?'); ">
...
<div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Mantención:</strong> Categoria
                                        <br>
                                        <p><small>*al pulsar editar, se trabaja con el Codigo de la Categoria para modificar*</small></p>
                                    </div>
                                    <div class="card-body card-block">
                                        <form  method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Tipo de Nivel</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <select name="txtnivel" id="txtnivel" class="form-control" placeholder="por favor seleccione" required>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Descripcion de la categoria.</label>
                                                </div>
                                                <div class="col-12 col-md-9">

                                                    <textarea name="txtdesc" id="txtdesc" rows="9" minlength="5" placeholder="breve descripcion de la categoria" class="form-control" value="<?php if(isset($_GET['edit'])) echo $getROW['desc_cate'];  ?>" required></textarea>
                                                </div>
                                            </div> 
